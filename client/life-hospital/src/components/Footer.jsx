  ...
  return (
    <div className='flex bg-black  p-4'>
      ...
      <div  className='flex-1 text-white text-center'>
        ...
        <Link to="https://www.facebook.com/profile.php?id=61563210868204&mibextid=kFxxJD" className='flex justify-center align-middle text-15 italic'><img src='https://cdn4.iconfinder.com/data/icons/various-icons-2/476/Facebook.png ' className='w-4 h-4 text-center mt-1'/> facebook</Link>
      ...
      <div  className=' flex flex-col flex-1 text-white self-start justify-start '>
        ...
        <form action="" className='flex flex-col self-start justify-start w-full '>
            ...
            <input type="text" placeholder='Meassage' className='w-full mb-4 h-20 rounded-lg p-4 placeholder'/>
